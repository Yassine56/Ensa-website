                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-12">
                        ...
                        <ul class="list-unstyled list-inline header-contact">
                            <li> <i class="fa fa-phone"></i> <a href="tel:">+212 641920298</a> </li>
                             <li> <i class="fa fa-envelope"></i> <a href="mailto:contact@sadaka.org">contact@Myteam.ac.ma</a> </li>
                       </ul> <!-- /.header-contact  -->
            ...
            <div class="item active">
              ...
              <div class="container">
                ...
                <div class="carousel-caption">
                  ...
                  <h2 class="carousel-title bounceInDown animated slow">ENSA MARRAKECH</h2>
                  <h4 class="carousel-subtitle bounceInUp animated slow "> Université Cady Ayad </h4>
                  <a href="#" class="btn btn-lg btn-secondary hidden-xs bounceInUp animated slow" data-toggle="modal" data-target="#donateModal">CONNEXION</a>
            ...
            <div class="item ">
              ...
              <div class="container">
                ...
                <div class="carousel-caption">
                  ...
                  <h2 class="carousel-title bounceInDown animated slow">ESPACE DE DEVELOPEMENT </h2>
                  <h4 class="carousel-subtitle bounceInUp animated slow"> pour les ingénieurs de demain </h4>
                  <a href="#" class="btn btn-lg btn-secondary hidden-xs bounceInUp animated" data-toggle="modal" data-target="#donateModal">CONNEXION</a>
            ...
            <div class="item ">
              ...
              <div class="container">
                ...
                <div class="carousel-caption">
                  ...
                  <h2 class="carousel-title bounceInDown animated slow" > UNE FAMILLE </h2>
                  <h4 class="carousel-subtitle bounceInUp animated slow"> inscrivez vous et rejoignez nos clubs </h4>
                  <a href="#" class="btn btn-lg btn-secondary hidden-xs bounceInUp animated slow" data-toggle="modal" data-target="#donateModal">CONNEXION	</a>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                  ...
                  <div class="about-us-col">
                        ...
                        <div class="col-details">
                          ...
                          <p>Notre mission, faire de nos élève de future cadre responsable et bien payé </p>
                ...
                <div class="col-md-3 col-sm-6">
                  ...
                  <div class="about-us-col">
                        ...
                        <h3 class="col-title">Faites un don</h3>
                        <div class="col-details">

                          <p>l'université Cady Ayad de Marrakech est prête a recevoir vos don pour permetre d'acheter les matériaux </p>
                ...
                <div class="col-md-3 col-sm-6">
                  ...
                  <div class="about-us-col">
                        ...
                        <div class="col-details">
                          ...
                          <p>S'il y'a quelque chose que vous ne comprenez pas, s'il vous plais n'hesitez surtout pas a poser des questions</p>
                ...
                <div class="col-md-3 col-sm-6">
                  ...
                  <div class="about-us-col">
                        ...
                        <div class="col-details">
                          ...
                          <p>Nous avons tout une panoplie de programme a vous présenter, mais le temps ne le permet pas</p>
    ...
    <footer class="main-footer">
        ...
        <div class="footer-bottom">
            ...
            <div class="container text-right">
                Yassine @ copyrights 2015 - by <a href="http://www.ouarmedia.com" target="_blank">Ouarmedia</a>
            </div>
        </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
                ...
                <h:form styleClass="form-donation">

                        <h3 class="title-style-1 text-center">Formulaire De Connexion <span class="title-under"></span>  </h3>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <button type="submit" class="btn btn-primary pull-right" name="donateNow" >Se Connecter</button>
                            </div>
